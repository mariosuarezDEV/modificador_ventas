...
class Grupos(models.Model):
    ...
    def __str__(self):
        return f'Grupo {self.descripcion}'
...
class Cheqdet(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'cheqdet'
        verbose_name = "Info. venta"
        verbose_name_plural = "Info. ventas"
    
    def __str__(self):
        return f'Detalle de venta con folio {self.foliodet}'
...
class Productos(models.Model):
    ...
    def __str__(self):
        return f'{self.descripcion} - {self.idproducto}'
...
class Productosdetalle(models.Model):
    ...
    def __str__(self):
        return f'Detalle de producto {self.idproducto}'
...
class Formasdepago(models.Model):
    ...
    def __str__(self):
        return f'Forma de pago {self.descripcion}'
...
class Chequespagos(models.Model):
    ...
    def __str__(self):
        return f'Pago con folio {self.folio}'
